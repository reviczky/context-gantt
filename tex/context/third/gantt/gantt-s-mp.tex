...
\long\def\dotitleelement#1#2%
  {\gantttmpa=\dimexpr\gantt!ganttunitlength*#2\relax
   ...
   \startMPdrawing
     ...
     label (btex \getvalue{gantt!titlestyle} #1 etex, center diam);
   \stopMPdrawing
...
\long\def\doganttbar[#1]#2#3#4%
  {\bgroup
   ...
   \startMPdrawing
     ...
     label.lft (btex \getvalue{gantt!style} #2 etex, center diag);
...
\long\def\doganttgroup#1#2#3%
  {\bgroup
   ...
   \startMPdrawing
     ...
     path diag; diag = (0,\ganttnum*cm+0.1cm)--(0,\ganttnum*cm+0.5cm);
     label.lft (btex \getvalue{gantt!style}\bf #1 etex, center diag); 
