...
\starttexdefinition initialize_gantt_chart_background
  \startMPdrawing
      ...
      x_gantt := ((0,0) -- (\the\gantt_chart_length*\ganttchartparameter\c!x, 0)) 
                 shifted (0, -0.5*\ganttchartparameter\c!y) ;
      y_gantt := ((0,0) -- (0, -(\gantt_task_count*\ganttchartparameter\c!y)))
                 shifted (0, -0.5*\ganttchartparameter\c!y) ;

      % Draw the frame
      draw x_gantt --
           y_gantt shifted (\the\gantt_chart_length*\ganttchartparameter\c!x,0) --
           reverse (x_gantt shifted (0,-\gantt_task_count*\ganttchartparameter\c!y)) --
           reverse (y_gantt) -- cycle %
...
\starttexdefinition draw_gantt_background_horizontal
  \startMPdrawing
      for i = 1 upto \gantt_task_count - 1:
...
\starttexdefinition draw_gantt_background_vertical
  \startMPdrawing
      for i = 1 upto \the\gantt_chart_length -1 :
